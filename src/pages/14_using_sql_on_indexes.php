...
<p>
    As of Elasticsearch version 6.3, there is a new feature available which may sound familiar to those
    working in de development world. Elasticsearch started to introduce SQL support.
</p>
<p>
    Aldo it is still a experimental feature, you can already experiment with how it works and interacts
    with a existing index, as long as it is running on Elasticsearch 6.3 or higher, which is something
    wat this workshop is doing.
</p>

<h3>14.1: Selecting all the records</h3>
<p>
    For this exercise you can try to use some of that SQL power for a simple task, retrieving all the records
    from your index. Try doing that by using <?php echo loadKibanaDevTools(); ?>.
</p>
<?php
...
<p>
    ...
    by using the DSL of Elasticsearch in <?php echo loadKibanaDevTools(); ?>. It should be shorter to write.
</p>
<?php
echo getHelpResources(
    [
...
?>
<p>
    For now SQL may come in handy for managing your Elasticsearch cluster, but I would recommend it for viewing
...
<p>
    Well that is it for this exercise.
</p>
